...
if (!PREVIEW_TOKEN) {
  console.error(
    'Set TERMAG_PREVIEW_AGENT_TOKEN before running preview seed, for example: TERMAG_PREVIEW_AGENT_TOKEN="tmag_$(openssl rand -hex 32)" npm run preview:seed -w apps/web'
  );
  process.exit(1);
}
