    ...
    try {
      switch (type) {
        ...
        case "caffeinate-start": {
          const requestedMode = String(msg.mode || "while-task");
          const mode: CaffeinateMode = [
            "disabled",
            "while-task",
            "lid-closed",
            "forever",
